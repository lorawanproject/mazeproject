...
function whileAsync(cond, body, chunkSize, period) {
  ...
  Maze.prototype.easy = function() {
    window.maze = new Maze({
        gridElement: document.getElementById('grid'),
        gridSize: new Point(10, 10),
        blockSize: 25,
        onSolved: function() {
          setTimeout(function() { alert('yay Completed, Try next challenge'); }, 200);
        }
      });
      maze.reset();
  ...
  Maze.prototype.mid = function() {
    ...
    Maze.prototype.hard = function() {
        window.maze = new Maze({
            gridElement: document.getElementById('grid'),
            gridSize: new Point(35, 35),
            blockSize: 25,
            onSolved: function() {
              setTimeout(function() { alert('yay Completed, Try next challenge'); }, 200);
            }
        ...
        Maze.prototype.extreme = function() {
            window.maze = new Maze({
                gridElement: document.getElementById('grid'),
                gridSize: new Point(50, 50),
                blockSize: 25,
                onSolved: function() {
                  setTimeout(function() { alert('yay Completed, Try next challenge'); }, 200);
                }
